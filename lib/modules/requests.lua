...
exports('request_model', requests.model)
...
exports('request_interior', requests.interior)
...
exports('request_texture', requests.texture)
...
exports('request_collision', requests.collision)
...
exports('request_anim', requests.anim)
...
exports('request_anim_set', requests.anim_set)
...
exports('request_clip_set', requests.clip_set)
...
exports('request_audio_bank', requests.audio_bank)
...
exports('request_scaleform_movie', requests.scaleform_movie)
...
exports('request_cutscene', requests.cutscene)
...
exports('request_ipl', requests.ipl)

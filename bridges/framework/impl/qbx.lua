...
if bdtk.framework ~= "qbx" then return end
...
if bdtk.is_server then
    ...
    function bridge.get_inventory(source)
        ...
        return player.PlayerData.inventory
    end
    ...
    function bridge.add_item(source, item_id, amount, data)
        ...
        if GetResourceState("ox_inventory") == "started" then
            ...
            TriggerClientEvent("qb-inventory:client:ItemBox", source, QBX.Shared.Items[item_id], "add", amount)
        end
    end
    ...
    function bridge.remove_item(source, item_id, amount)
        ...
        if GetResourceState("ox_inventory") == "started" then
            ...
            TriggerClientEvent("qb-inventory:client:ItemBox", source, QBX.Shared.Items[item_id], "remove", amount)
        end
    end
    ...
    function bridge.register_item(item, cb)
        ...
        QBX.Functions.CreateUseableItem(item, function(src) cb(src) end)
    end
